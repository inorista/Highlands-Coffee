...
const kSelectedSizeBG = Color(0xffBC945D);
const kUnselectedSizeBG = Color(0xffF1E9DE);

const kSelectedSizeText = Colors.white;
const kUnselectedSizeText = Colors.black;

const kSelectedCompare = Color(0xff513628);
const kUnselectedCompare = Color(0xffE5DBCE);
